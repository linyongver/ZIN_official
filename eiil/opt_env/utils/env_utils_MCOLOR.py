...
def get_envs(cuda=True, flags=None):
  ...
  envs = [
    _make_environment(mnist_train[0][::2], mnist_train[1][::2], flags.train_env_1__label_noise),
    _make_environment(mnist_train[0][1::2], mnist_train[1][1::2], flags.train_env_2__label_noise),
    _make_environment(mnist_val[0], mnist_val[1], flags.test_env__label_noise)
  ]
  return envs
